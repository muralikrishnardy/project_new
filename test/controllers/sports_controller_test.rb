...
class SportsControllerTest < ActionController::TestCase
  ...
  test "should create sport" do
    assert_difference('Sport.count') do
      post :create, sport: { num_of_matches: @sport.num_of_matches, num_of_players: @sport.num_of_players, type: @sport.type }
    end
  ...
  test "should update sport" do
    patch :update, id: @sport, sport: { num_of_matches: @sport.num_of_matches, num_of_players: @sport.num_of_players, type: @sport.type }
    assert_redirected_to sport_path(assigns(:sport))
  end
